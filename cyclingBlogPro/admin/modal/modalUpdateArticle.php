...
<!-- Modal -->
<div class="modal fade" id="updateArticle" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content bg-secondary text-warning">
            <div class="modal-header">
                <h5 class="modal-title text-uppercase" id="exampleModalLabel">Modifier article</h5>
            ...
            <div class="input-group input-group-sm mb-3">
                ...
                <input type="text" name="title" value="<?= $results['title']?>" class="form-control" aria-label="Sizing example input"
            ...
            <div class="input-group input-group-sm mb-3">
                ...
                <input type="text" name="name" value="<?= $results['name'],' ',$results['surname']?>" class="form-control" aria-label="Sizing example input"
                    aria-describedby="inputGroup-sizing-sm">
            </div>
            <div class="input-group input-group-sm mb-3">
                <div class="input-group-prepend">
                ...
                <input type="text" name="date" value="<?= $results['creationDate']?>" class="form-control" aria-label="Sizing example input"
                    aria-describedby="inputGroup-sizing-sm">
            </div>
            <!-- <div class="input-group input-group-sm mb-3"> -->
                
            <textarea class="form-control" name="article" value="" id="exampleFormControlTextarea1" rows="13">"<?= $results['article']?>"</textarea>
            <!-- </div> -->
            <!-- <button class="btn btn btn-primary" name="update">Modifier<span class="badge badge-primary"></span>
            </button> -->
            <div class="modal-footer">
                <button type="submit" id="subpost" value="Envoyer" name="updateArticle" class="btn btn-warning updateArticle">Valider les
                    modifications 
                </button>
