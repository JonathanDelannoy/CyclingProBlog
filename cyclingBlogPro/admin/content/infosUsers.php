...
$id = ($_GET['id']);
$req = $bdd->query('SELECT * FROM users  INNER JOIN addresses  on users.idAddress = addresses.id INNER JOIN addressCommandes on users.idAddressCommandes = addressCommandes.id WHERE id=' .$id);
$elements = $req->fetch();
