...
<section class="back13 container-fluid">
        ...
        <div class="container-fluid w-75">
            <div class="row m-1 my-3">
                <div>
                    <div class="col-12 d-flex bord p-0 m-0">
                        <div class="col-4">
                            <iframe src="https://www.youtube.com/embed/hcFyMT2ALfQ" class="h-100 w-100" frameborder="0" 
                        ...
                        <div class="col-8 m-2">
                            ...
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestiae distinctio,
                                ...
                                nulla molestias minima officiis quia quo, earum possimus maiores sit.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row m-1 my-3">
                <div>
                    <div class="col-12 d-flex bord p-0 m-0">
                        <div class="col-4">
                            <iframe src="https://www.youtube.com/embed/LbM8rwzBS-U" class="h-100 w-100" frameborder="0" 
                                allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
                            </iframe>
                        </div>
                        <div class="col-8 m-2">
            ...
            <div class="row m-1 my-3">
                <div>
                    <div class="col-12 d-flex bord p-0 m-0">
                        <div class="col-4">
                            <iframe src="https://www.youtube.com/embed/DxOeZVa672Q" class="h-100 w-100" frameborder="0" 
                                allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
                            </iframe>
                        </div>
                        <div class="col-8 m-2">
