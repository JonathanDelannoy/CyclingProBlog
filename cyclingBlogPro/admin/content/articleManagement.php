...
require_once("../modal/modalUpdateArticle.php");

$id = $_GET['id'];
$req = $bdd->query('SELECT * FROM articles a INNER JOIN users u ON a.idUser = u.id WHERE id = ' .$id);
?>
    ...
    while ($donnees =$req->fetch()) {
            ?>
                    <tr class="">
                        ...
                        <td>
                            <a type="button" href="?id=<?= $donnees['id'] ?>" data-target="#updateArticle"
